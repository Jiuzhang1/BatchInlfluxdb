...
public class InfluxdbUtils {
    ...
    @Value("${spring.influx.remote-url}")
    private String url;
    /**
     ...
     * @return
     */
    public List<Map> fetchRecords(String query){
     ...
     * @return
     */
    public List<Map> fetchRecords(String fieldKeys, String measurement){
     ...
     * @return
     */
    public List<Map> fetchRecords(String fieldKeys, String measurement, String order){
        StringBuilder query = new StringBuilder();
        query.append("select ").append(fieldKeys).append(" from ").append(measurement);
     ...
     * @return
     */
    public List<Map> fetchRecords(String fieldKeys, String measurement, String order, String limit){
        StringBuilder query = new StringBuilder();
        query.append("select ").append(fieldKeys).append(" from ").append(measurement);
        query.append(" order by ").append(order);
        query.append(limit);
